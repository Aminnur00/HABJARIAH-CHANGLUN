...
if (isset($_POST["submit"])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM sellerdb WHERE username = '$username' AND password = '$pass'");
    $stmt->execute();
...
<body onload="loadCookies()">
    ...
    <div class="w3-container w3-padding-64 form-container">
        ...
        <form name="loginForm" class="w3-container" action="login2.php" method="post">
            <p>
            ...
            <p>Pengguna Baharu? <a href="register2.php">Daftar Sekarang</a></p>
