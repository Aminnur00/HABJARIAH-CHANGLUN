...
//Check if the email is already exist
        $sql = "SELECT COUNT(username) AS num FROM admindb WHERE username = :username";
...
//Insert the input into the database
        $sql = "INSERT INTO admindb (username, name, password, email, phone) VALUES (?,?,?,?,?)";
        $stmt = $conn->prepare($sql);
...
<body>
    ...
    <div class="w3-container w3-padding-64 form-container">
        ...
        <form name="signupForm" class="w3-container" action="adminregister.php" method="post">
            ...
            <p>Sudah Mempunyai akaun? <a href="loginadmin.php">Log Masuk</a></p>
    </form>
    </div>
    </div>
