<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $phone = $_POST["phone"];
        $sqlregister = "INSERT INTO `applysale`(`nameproduct`, `price`, `type`, `quantity`, `condition`, `location`, `phone`)
         VALUES('$name', '$price', '$type', '$quantity', '$condition', '$location', '$phone')";
        ...
        try{
            ...
            if (file_exists($_FILES["fileToUpload"]["tmp_name"]) || is_uploaded_file($_FILES["fileToUpload"]["tmp_name"])){
                ...
                echo "<script>window.location.replace('listproduct.php')</script>";
            }    
            
        }catch (PDOException $e) {
                echo"<script>alert('Permohonan tidak berjaya. Sila cuba lagi')</script>";
                echo "<script>window.location.replace('applysales.php')</script>";
            }
    }
...
<body onload="loadCookies()">
    ...
    <div class="w3-container w3-padding-64 form-container">
        <div class="w3-card">
            ...
            <form class="w3-container w3-padding " name="registerForm" action="applysales.php" method="post" onsubmit="return confirmDialog()" enctype="multipart/form-data">
                

            <p>
                <label class="w3-text-black"><b>Nama Produk</b></label>
                <input class="w3-input w3-border w3-round" name="nameproduct" type="text" id="idnameproduct" required>
            </p>
            ...
            <p>
                ...
                <input class="w3-input w3-border w3-round" name="condition" type="text" id="idcondition" required>
            </p> 
            ...
            <p>
                <label class="w3-text-black"><b>Gambar Produk</b></label>
