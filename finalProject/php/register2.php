...
//Insert the input into the database
        $sql = "INSERT INTO userdb (username, password, email, phone) VALUES (?,?,?,?)";
        $stmt = $conn->prepare($sql);
        $result = $stmt->execute([$username, $pass, $email, $phone]);
...
<body>
    ...
    <div class="w3-container w3-padding-64 form-container">
        ...
        <form name="signupForm" class="w3-container" action="register2.php" method="post">
            ...
            <p>Have an account? <a href="login2.php">Log in</a></p>
    </form>
    </div>
    </div>
