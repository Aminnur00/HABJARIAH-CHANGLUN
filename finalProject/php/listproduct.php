...
$sqldata = "SELECT * FROM `applysale` ORDER BY applysaleid DESC";
...
<hr>
    <div class="w3-center w3-padding-10 ">
        <h1><strong>SENARAI JUALAN</strong></h1>
</div><hr>
<hr>
...
<div class="w3-grid-template">
             ...
             $cart = "cart";
                foreach ($rows as $product){
                    ...
                    <div class='w3-padding-small'><a href='detailproduct.php?id=$productid'><img class='w3-container w3-image' 
                    src=../images/application/$name.png onerror=this.onerror=null;this.src='../images/books/default.jpg'></a></div><h5><strong>$name</h5>
                    <b>RM$price</b><br>KUANTITI:- $quantity</br><b>LOKASI:-$location<br><br>
                    <input type='button' class='w3-button w3-blue w3-round' id='button_id' value='Beli / Derma' onClick='addCart($productid);'><br><br>
                    </div></div>";
